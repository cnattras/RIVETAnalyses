...
//cout << "sqrtS = " << sqrtS()/GeV << " GeV, collSys = " << (collSys == AuAu130 ? "AuAu130" : "UNKNOWN") << ", fixed centrality = " << fixedcentralityOpt << endl;
       ...
       book(_h["PionMinusMinBias"], 7, 1, 2);
       book(_h["ProtonMinBias"], 9, 1, 1);
       book(_h["AntiProtonMinBias"], 9, 1, 2);
       book(_h["Fig10PionPlusCent0_5"], 10, 1, 1);
       book(_h["Fig10PionPlusCent5_15"], 10, 1, 3);
       book(_h["Fig10PionPlusCent15_30"], 10, 1, 5);
       book(_h["Fig10PionPlusCent30_60"], 10, 1, 7);
       book(_h["Fig10PionMinusCent0_5"], 10, 1, 2);
       book(_h["Fig10PionMinusCent5_15"], 10, 1, 4);
       book(_h["Fig10PionMinusCent15_30"], 10, 1, 6);
       book(_h["Fig10PionMinusCent30_60"], 10, 1, 8);
       book(_h["Fig10PionPlusCent60_92"], 11, 1, 1);
       book(_h["Fig10PionMinusCent60_92"], 11, 1, 2);
       book(_h["Fig10KaonPlusCent0_5"], 12, 1, 1);
       book(_h["Fig10KaonPlusCent5_15"], 12, 1, 3);
       book(_h["Fig10KaonPlusCent15_30"], 12, 1, 5);
       book(_h["Fig10KaonPlusCent30_60"], 12, 1, 7);
       book(_h["Fig10KaonMinusCent0_5"], 12, 1, 2);
       book(_h["Fig10KaonMinusCent5_15"], 12, 1, 4);
       book(_h["Fig10KaonMinusCent15_30"], 12, 1, 6);
       book(_h["Fig10KaonMinusCent30_60"], 12, 1, 8);
       book(_h["Fig10KaonPlusCent60_92"], 13, 1, 1);
       book(_h["Fig10KaonMinusCent60_92"], 13, 1, 2);
       book(_h["Fig10ProtonCent0_5"], 14, 1, 1);
       book(_h["Fig10AntiProtonCent0_5"], 14, 1, 2);
       book(_h["Fig10ProtonCent5_15"], 15, 1, 1);
       book(_h["Fig10AntiProtonCent5_15"], 15, 1, 2);
       book(_h["Fig10ProtonCent15_30"], 16, 1, 1);
       book(_h["Fig10AntiProtonCent15_30"], 17, 1, 1);
       book(_h["Fig10ProtonCent30_60"], 18, 1, 1);
       book(_h["Fig10AntiProtonCent30_60"], 19, 1, 1);
       book(_h["Fig10ProtonCent60_92"], 20, 1, 1);
       book(_h["Fig10AntiProtonCent60_92"], 20, 1, 2);
/*
       string refnameRcpPionPlus = mkAxisCode(21,1,1);
       ...
       string refnameRcpPionMinus = mkAxisCode(21,1,2);
       ...
       string refnameRcpKaonPlus = mkAxisCode(22,1,1);
       ...
       string refnameRcpKaonMinus = mkAxisCode(22,1,2);
       ...
       string refnameRcpProton = mkAxisCode(23,1,1);
       ...
       string refnameRcpAntiProton = mkAxisCode(23,1,2);
...
*/
       book(_h["Fig12PionPlusCent0_5"], 24, 1, 1);
       book(_h["Fig12PionPlusCent5_15"], 24, 1, 3);
       book(_h["Fig12PionPlusCent15_30"], 24, 1, 5);
       book(_h["Fig12PionPlusCent30_60"], 24, 1, 7);
       book(_h["Fig12PionMinusCent0_5"], 24, 1, 2);
       book(_h["Fig12PionMinusCent5_15"], 24, 1, 4);
       book(_h["Fig12PionMinusCent15_30"], 24, 1, 6);
       book(_h["Fig12PionMinusCent30_60"], 24, 1, 8);
       book(_h["Fig12PionPlusCent60_92"], 25, 1, 1);
       book(_h["Fig12PionMinusCent60_92"], 25, 1, 2);
       book(_h["Fig12KaonPlusCent0_5"], 26, 1, 1);
       book(_h["Fig12KaonPlusCent5_15"], 26, 1, 3);
       book(_h["Fig12KaonPlusCent15_30"], 26, 1, 5);
       book(_h["Fig12KaonPlusCent30_60"], 26, 1, 7);
       book(_h["Fig12KaonPlusCent60_92"], 26, 1, 9);
       book(_h["Fig12KaonMinusCent0_5"], 26, 1, 2);
       book(_h["Fig12KaonMinusCent5_15"], 26, 1, 4);
       book(_h["Fig12KaonMinusCent15_30"], 26, 1, 6);
       book(_h["Fig12KaonMinusCent30_60"], 26, 1, 8);
       book(_h["Fig12KaonMinusCent60_92"], 26, 1, 10);
       book(_h["Fig12ProtonCent0_5"], 27, 1, 1);
       book(_h["Fig12ProtonCent5_15"], 27, 1, 3);
       book(_h["Fig12ProtonCent15_30"], 27, 1, 5);
       book(_h["Fig12ProtonCent30_60"], 27, 1, 7);
       book(_h["Fig12AntiProtonCent0_5"], 27, 1, 2);
       book(_h["Fig12AntiProtonCent5_15"], 27, 1, 4);
       book(_h["Fig12AntiProtonCent15_30"], 27, 1, 6);
...
//            _h["Fig11KaonPlusCentral"]->fill(p.pT()/GeV);
            ...
            _h["Fig10KaonPlusCent15_30"]->fill(p.pT()/GeV);
...
double scaleFactor = 1.0 / (2 * M_PI ); 
      ...
      _h["Fig10PionPlusCent0_5"]->scaleW(scaleFactor * 1./_c["Cent0_5"]->sumW());
      _h["Fig10PionPlusCent5_15"]->scaleW(scaleFactor * 1./_c["Cent5_15"]->sumW());
      _h["Fig10PionPlusCent15_30"]->scaleW(scaleFactor * 1./_c["Cent15_30"]->sumW());
      _h["Fig10PionPlusCent30_60"]->scaleW(scaleFactor * 1./_c["Cent30_60"]->sumW());
      _h["Fig10PionMinusCent0_5"]->scaleW(scaleFactor * 1./_c["Cent0_5"]->sumW());
      _h["Fig10PionMinusCent5_15"]->scaleW(scaleFactor * 1./_c["Cent5_15"]->sumW());
      _h["Fig10PionMinusCent15_30"]->scaleW(scaleFactor * 1./_c["Cent15_30"]->sumW());
      _h["Fig10PionMinusCent30_60"]->scaleW(scaleFactor * 1./_c["Cent30_60"]->sumW());
      _h["Fig10PionPlusCent60_92"]->scaleW(scaleFactor * 1./_c["Cent60_92"]->sumW());
      _h["Fig10PionMinusCent60_92"]->scaleW(scaleFactor * 1./_c["Cent60_92"]->sumW());

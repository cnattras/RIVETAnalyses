...
# Analysis object: /PHENIX_2004_I623413/d02-x01-y02
# Timestamp: 16-12-2025 (21:30:07)
...
ax_title  = 'Invariant yields for $\\pi^{-}$ measured in minimum-bias events.'
ax_xScale = 'linear'
ax_yScale = 'log'
xLims = (0.0, 92.0)
yLims = (9.0, 11000.0)
...
exec(open(prefix+'d02-x01-y02__data.py').read(), dataf)
...
plt.savefig(os.path.join(plot_outdir, 'd02-x01-y02.pdf'), format='PDF')
plt.savefig(os.path.join(plot_outdir, 'd02-x01-y02.png'), format='PNG')

...
# Analysis object: /PHENIX_2004_I623413/d12-x01-y08
...
exec(open(prefix+'d12-x01-y08__data.py').read(), dataf)
...
plt.savefig(os.path.join(plot_outdir, 'd12-x01-y08.pdf'), format='PDF')
plt.savefig(os.path.join(plot_outdir, 'd12-x01-y08.png'), format='PNG')

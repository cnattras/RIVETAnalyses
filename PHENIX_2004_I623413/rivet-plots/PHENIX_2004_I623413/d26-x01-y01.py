...
# Analysis object: /PHENIX_2004_I623413/d26-x01-y01
...
ax_yScale = 'log'
xLims = (0.4, 1.8)
yLims = (0.09000000000000001, 110.00000000000001)
...
exec(open(prefix+'d26-x01-y01__data.py').read(), dataf)
...
plt.savefig(os.path.join(plot_outdir, 'd26-x01-y01.pdf'), format='PDF')
plt.savefig(os.path.join(plot_outdir, 'd26-x01-y01.png'), format='PNG')

...
# Analysis object: /PHENIX_2004_I623413/d16-x01-y01
...
ax_title  = 'Minimum-bias invariant yields for $K^{+}$ in equal $p_{T}$ bins.'
ax_xScale = 'linear'
ax_yScale = 'log'
xLims = (0.5, 3.55)
...
exec(open(prefix+'d16-x01-y01__data.py').read(), dataf)
...
plt.savefig(os.path.join(plot_outdir, 'd16-x01-y01.pdf'), format='PDF')
plt.savefig(os.path.join(plot_outdir, 'd16-x01-y01.png'), format='PNG')

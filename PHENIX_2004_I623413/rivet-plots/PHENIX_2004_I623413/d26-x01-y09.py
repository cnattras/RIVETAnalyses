...
# Analysis object: /PHENIX_2004_I623413/d26-x01-y09
...
exec(open(prefix+'d26-x01-y09__data.py').read(), dataf)
...
plt.savefig(os.path.join(plot_outdir, 'd26-x01-y09.pdf'), format='PDF')
plt.savefig(os.path.join(plot_outdir, 'd26-x01-y09.png'), format='PNG')

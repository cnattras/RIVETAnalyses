...
# Analysis object: /PHENIX_2004_I623413/d08-x01-y02
...
ax_title  = 'Invariant yields of $\\bar{p}$ in each event at 0-5$\\%$ centrality'
ax_xScale = 'linear'
ax_yScale = 'log'
xLims = (0.4, 1.7)
yLims = (0.009000000000000001, 11.0)
...
exec(open(prefix+'d08-x01-y02__data.py').read(), dataf)
...
plt.savefig(os.path.join(plot_outdir, 'd08-x01-y02.pdf'), format='PDF')
plt.savefig(os.path.join(plot_outdir, 'd08-x01-y02.png'), format='PNG')

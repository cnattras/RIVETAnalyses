...
# Analysis object: /PHENIX_2004_I623413/d22-x01-y02_Central
...
exec(open(prefix+'d22-x01-y02_Central__data.py').read(), dataf)
...
plt.savefig(os.path.join(plot_outdir, 'd22-x01-y02_Central.pdf'), format='PDF')
plt.savefig(os.path.join(plot_outdir, 'd22-x01-y02_Central.png'), format='PNG')

...
# Analysis object: /PHENIX_2004_I623413/d19-x01-y01
...
ax_title  = 'Invariant yields for $\\pi^+$ at 60-92$\\%$ centrality'
ax_xScale = 'linear'
ax_yScale = 'log'
xLims = (0.5, 3.55)
yLims = (9e-05, 1.1)
...
exec(open(prefix+'d19-x01-y01__data.py').read(), dataf)
...
plt.savefig(os.path.join(plot_outdir, 'd19-x01-y01.pdf'), format='PDF')
plt.savefig(os.path.join(plot_outdir, 'd19-x01-y01.png'), format='PNG')

...
# Analysis object: /PHENIX_2004_I623413/d15-x01-y02
...
ax_yLabel = 'central/peripheral'
ax_title  = 'Minimum-bias invariant yields for $\\pi^{-}$ in equal $p_{T}$ bins.'
ax_xScale = 'linear'
ax_yScale = 'log'
xLims = (0.5, 3.55)
...
exec(open(prefix+'d15-x01-y02__data.py').read(), dataf)
...
plt.savefig(os.path.join(plot_outdir, 'd15-x01-y02.pdf'), format='PDF')
plt.savefig(os.path.join(plot_outdir, 'd15-x01-y02.png'), format='PNG')

...
# Analysis object: /PHENIX_2004_I623413/d23-x01-y02_Peripheral
...
ax_xLabel = 'Particle'
ax_yLabel = '$\\alpha_{coll}$'
ax_title  = 'Fit parameters for each particle species using Eqs (19) and (20).'
ax_xScale = 'linear'
ax_yScale = 'linear'
xLims = (0.5, 3.9)
yLims = (0.11, 1.0)
...
exec(open(prefix+'d23-x01-y02_Peripheral__data.py').read(), dataf)
...
plt.savefig(os.path.join(plot_outdir, 'd23-x01-y02_Peripheral.pdf'), format='PDF')
plt.savefig(os.path.join(plot_outdir, 'd23-x01-y02_Peripheral.png'), format='PNG')

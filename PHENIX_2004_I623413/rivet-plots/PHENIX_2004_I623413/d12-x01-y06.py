...
# Analysis object: /PHENIX_2004_I623413/d12-x01-y06
...
exec(open(prefix+'d12-x01-y06__data.py').read(), dataf)
...
plt.savefig(os.path.join(plot_outdir, 'd12-x01-y06.pdf'), format='PDF')
plt.savefig(os.path.join(plot_outdir, 'd12-x01-y06.png'), format='PNG')

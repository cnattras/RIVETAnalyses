...
# Analysis object: /PHENIX_2004_I623413/d13-x01-y01
...
ax_title  = 'Invariant yields of $\\bar{p}$ in each event at 30-60$\\%$ centrality'
ax_xScale = 'linear'
ax_yScale = 'log'
xLims = (0.4, 1.8)
yLims = (0.0009000000000000001, 1.1)
...
exec(open(prefix+'d13-x01-y01__data.py').read(), dataf)
...
plt.savefig(os.path.join(plot_outdir, 'd13-x01-y01.pdf'), format='PDF')
plt.savefig(os.path.join(plot_outdir, 'd13-x01-y01.png'), format='PNG')

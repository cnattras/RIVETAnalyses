...
# Analysis object: /PHENIX_2004_I623413/d24-x01-y04
...
ax_yScale = 'log'
xLims = (0.2, 2.7)
yLims = (0.09000000000000001, 1100.0)
...
exec(open(prefix+'d24-x01-y04__data.py').read(), dataf)
...
plt.savefig(os.path.join(plot_outdir, 'd24-x01-y04.pdf'), format='PDF')
plt.savefig(os.path.join(plot_outdir, 'd24-x01-y04.png'), format='PNG')

...
# Analysis object: /PHENIX_2004_I623413/d24-x01-y01
...
ax_xLabel = 'Particle'
ax_yLabel = '$n_{pp}$'
ax_title  = 'Values of the parameters $n_{pp}$ and $x$ from fitting Eq. (21).'
ax_xScale = 'linear'
ax_yScale = 'log'
xLims = (0.2, 2.7)
...
exec(open(prefix+'d24-x01-y01__data.py').read(), dataf)
...
plt.savefig(os.path.join(plot_outdir, 'd24-x01-y01.pdf'), format='PDF')
plt.savefig(os.path.join(plot_outdir, 'd24-x01-y01.png'), format='PNG')

...
# Analysis object: /PHENIX_2004_I623413/d23-x01-y01_Peripheral
...
exec(open(prefix+'d23-x01-y01_Peripheral__data.py').read(), dataf)
...
plt.savefig(os.path.join(plot_outdir, 'd23-x01-y01_Peripheral.pdf'), format='PDF')
plt.savefig(os.path.join(plot_outdir, 'd23-x01-y01_Peripheral.png'), format='PNG')

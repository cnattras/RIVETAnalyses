...
# Analysis object: /PHENIX_2004_I623413/d07-x01-y02
...
ax_title  = 'Invariant yields of $K^-$ in each event at 60-92$\\%$ centrality'
ax_xScale = 'linear'
ax_yScale = 'log'
xLims = (0.2, 2.3)
...
exec(open(prefix+'d07-x01-y02__data.py').read(), dataf)
...
plt.savefig(os.path.join(plot_outdir, 'd07-x01-y02.pdf'), format='PDF')
plt.savefig(os.path.join(plot_outdir, 'd07-x01-y02.png'), format='PNG')

...
# Analysis object: /PHENIX_2004_I623413/d17-x01-y01
...
ax_title  = 'Minimum-bias invariant yields for $p$ in equal $p_{T}$ bins.'
ax_xScale = 'linear'
ax_yScale = 'log'
xLims = (0.5, 3.8)
yLims = (9e-05, 11.0)
...
exec(open(prefix+'d17-x01-y01__data.py').read(), dataf)
...
plt.savefig(os.path.join(plot_outdir, 'd17-x01-y01.pdf'), format='PDF')
plt.savefig(os.path.join(plot_outdir, 'd17-x01-y01.png'), format='PNG')

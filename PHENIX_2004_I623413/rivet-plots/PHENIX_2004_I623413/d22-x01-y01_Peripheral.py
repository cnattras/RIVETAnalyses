...
# Analysis object: /PHENIX_2004_I623413/d22-x01-y01_Peripheral
...
ax_title  = 'Invariant yields for $p$ at 60-92$\\%$ centrality'
ax_xScale = 'linear'
ax_yScale = 'linear'
xLims = (0.4, 1.8)
yLims = (0.11, 1.0)
...
exec(open(prefix+'d22-x01-y01_Peripheral__data.py').read(), dataf)
...
plt.savefig(os.path.join(plot_outdir, 'd22-x01-y01_Peripheral.pdf'), format='PDF')
plt.savefig(os.path.join(plot_outdir, 'd22-x01-y01_Peripheral.png'), format='PNG')

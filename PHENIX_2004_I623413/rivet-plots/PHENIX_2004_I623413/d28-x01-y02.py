...
# Analysis object: /PHENIX_2004_I623413/d28-x01-y02
# Timestamp: 16-12-2025 (21:30:11)
...
ax_yLabel = '$\\pi^-$'
ax_title  = 'The $\\langle p_{T} \\rangle$ in MeV/$c$ for hadrons produced at midrapidity.'
ax_xScale = 'linear'
ax_yScale = 'log'
xLims = (0.5, 3.2)
yLims = (9e-05, 1.1)
...
exec(open(prefix+'d28-x01-y02__data.py').read(), dataf)
...
plt.savefig(os.path.join(plot_outdir, 'd28-x01-y02.pdf'), format='PDF')
plt.savefig(os.path.join(plot_outdir, 'd28-x01-y02.png'), format='PNG')

...
# Analysis object: /PHENIX_2004_I623413/d10-x01-y01
...
ax_title  = 'Invariant yields of $p$ in each event at 15-30$\\%$ centrality'
ax_xScale = 'linear'
ax_yScale = 'log'
xLims = (0.2, 2.3)
yLims = (0.009000000000000001, 1100.0)
...
exec(open(prefix+'d10-x01-y01__data.py').read(), dataf)
...
plt.savefig(os.path.join(plot_outdir, 'd10-x01-y01.pdf'), format='PDF')
plt.savefig(os.path.join(plot_outdir, 'd10-x01-y01.png'), format='PNG')

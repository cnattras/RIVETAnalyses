...
# Analysis object: /PHENIX_2004_I623413/d10-x01-y07
...
ax_yScale = 'log'
xLims = (0.2, 2.3)
yLims = (0.009000000000000001, 110.00000000000001)
...
exec(open(prefix+'d10-x01-y07__data.py').read(), dataf)
...
plt.savefig(os.path.join(plot_outdir, 'd10-x01-y07.pdf'), format='PDF')
plt.savefig(os.path.join(plot_outdir, 'd10-x01-y07.png'), format='PNG')

...
# Analysis object: /PHENIX_2004_I623413/d03-x01-y01
...
ax_title  = 'Invariant yields for $p$ measured in minimum-bias events.'
ax_xScale = 'linear'
ax_yScale = 'log'
xLims = (0.0, 92.0)
yLims = (90.0, 1100.0)
...
exec(open(prefix+'d03-x01-y01__data.py').read(), dataf)
...
plt.savefig(os.path.join(plot_outdir, 'd03-x01-y01.pdf'), format='PDF')
plt.savefig(os.path.join(plot_outdir, 'd03-x01-y01.png'), format='PNG')

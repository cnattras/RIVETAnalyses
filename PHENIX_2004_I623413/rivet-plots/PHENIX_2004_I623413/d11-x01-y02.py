...
# Analysis object: /PHENIX_2004_I623413/d11-x01-y02
...
exec(open(prefix+'d11-x01-y02__data.py').read(), dataf)
...
plt.savefig(os.path.join(plot_outdir, 'd11-x01-y02.pdf'), format='PDF')
plt.savefig(os.path.join(plot_outdir, 'd11-x01-y02.png'), format='PNG')

...
# Analysis object: /PHENIX_2004_I623413/d29-x01-y05
...
ax_yLabel = '0.55 $<$ $p_{T}$ $<$ 1.85 (GeV/$c$)'
...
exec(open(prefix+'d29-x01-y05__data.py').read(), dataf)
...
plt.savefig(os.path.join(plot_outdir, 'd29-x01-y05.pdf'), format='PDF')
plt.savefig(os.path.join(plot_outdir, 'd29-x01-y05.png'), format='PNG')

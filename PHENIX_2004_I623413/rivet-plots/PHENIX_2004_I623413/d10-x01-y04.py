...
# Analysis object: /PHENIX_2004_I623413/d10-x01-y04
...
exec(open(prefix+'d10-x01-y04__data.py').read(), dataf)
...
plt.savefig(os.path.join(plot_outdir, 'd10-x01-y04.pdf'), format='PDF')
plt.savefig(os.path.join(plot_outdir, 'd10-x01-y04.png'), format='PNG')

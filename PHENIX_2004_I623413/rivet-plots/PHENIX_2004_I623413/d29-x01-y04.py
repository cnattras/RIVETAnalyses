...
# Analysis object: /PHENIX_2004_I623413/d29-x01-y04
...
ax_yLabel = '0.45 $<$ $p_{T}$ $<$ 1.35 (GeV/$c$)'
ax_title  = 'The resulting inverse slopes in MeV.'
ax_xScale = 'linear'
ax_yScale = 'log'
xLims = (0.0, 92.0)
yLims = (90.0, 1100.0)
...
exec(open(prefix+'d29-x01-y04__data.py').read(), dataf)
...
plt.savefig(os.path.join(plot_outdir, 'd29-x01-y04.pdf'), format='PDF')
plt.savefig(os.path.join(plot_outdir, 'd29-x01-y04.png'), format='PNG')

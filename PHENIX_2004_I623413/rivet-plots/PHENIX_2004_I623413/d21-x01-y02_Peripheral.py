...
# Analysis object: /PHENIX_2004_I623413/d21-x01-y02_Peripheral
...
ax_title  = 'Invariant yields for $\\bar{p}$ at 0-5$\\%$ centrality'
ax_xScale = 'linear'
ax_yScale = 'linear'
xLims = (0.2, 2.7)
yLims = (0.11, 1.0)
...
exec(open(prefix+'d21-x01-y02_Peripheral__data.py').read(), dataf)
...
plt.savefig(os.path.join(plot_outdir, 'd21-x01-y02_Peripheral.pdf'), format='PDF')
plt.savefig(os.path.join(plot_outdir, 'd21-x01-y02_Peripheral.png'), format='PNG')

...
# Analysis object: /PHENIX_2004_I623413/d08-x01-y01
...
ax_title  = 'Invariant yields of $p$ in each event at 0-5$\\%$ centrality'
ax_xScale = 'linear'
ax_yScale = 'log'
xLims = (0.4, 1.7)
...
exec(open(prefix+'d08-x01-y01__data.py').read(), dataf)
...
plt.savefig(os.path.join(plot_outdir, 'd08-x01-y01.pdf'), format='PDF')
plt.savefig(os.path.join(plot_outdir, 'd08-x01-y01.png'), format='PNG')

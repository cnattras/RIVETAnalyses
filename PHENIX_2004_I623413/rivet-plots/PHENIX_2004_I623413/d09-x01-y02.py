...
# Analysis object: /PHENIX_2004_I623413/d09-x01-y02
...
ax_title  = 'Invariant yields of $\\bar{p}$ in each event at 5-15$\\%$ centrality'
ax_xScale = 'linear'
ax_yScale = 'log'
xLims = (0.5, 3.4)
...
exec(open(prefix+'d09-x01-y02__data.py').read(), dataf)
...
plt.savefig(os.path.join(plot_outdir, 'd09-x01-y02.pdf'), format='PDF')
plt.savefig(os.path.join(plot_outdir, 'd09-x01-y02.png'), format='PNG')

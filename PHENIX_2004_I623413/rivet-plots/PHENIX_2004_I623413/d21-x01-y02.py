...
# Analysis object: /PHENIX_2004_I623413/d21-x01-y02
...
ax_yScale = 'log'
xLims = (0.2, 2.7)
yLims = (0.0009000000000000001, 1100.0)
...
exec(open(prefix+'d21-x01-y02__data.py').read(), dataf)
...
plt.savefig(os.path.join(plot_outdir, 'd21-x01-y02.pdf'), format='PDF')
plt.savefig(os.path.join(plot_outdir, 'd21-x01-y02.png'), format='PNG')

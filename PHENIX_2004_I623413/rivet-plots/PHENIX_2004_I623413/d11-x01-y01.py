...
# Analysis object: /PHENIX_2004_I623413/d11-x01-y01
# Timestamp: 16-12-2025 (21:30:08)
...
ax_title  = 'Invariant yields of $\\bar{p}$ in each event at 15-30$\\%$ centrality'
ax_xScale = 'linear'
ax_yScale = 'log'
xLims = (0.2, 2.2)
yLims = (0.0009000000000000001, 110.00000000000001)
...
exec(open(prefix+'d11-x01-y01__data.py').read(), dataf)
...
plt.savefig(os.path.join(plot_outdir, 'd11-x01-y01.pdf'), format='PDF')
plt.savefig(os.path.join(plot_outdir, 'd11-x01-y01.png'), format='PNG')

...
# Analysis object: /PHENIX_2004_I623413/d27-x01-y07
...
exec(open(prefix+'d27-x01-y07__data.py').read(), dataf)
...
plt.savefig(os.path.join(plot_outdir, 'd27-x01-y07.pdf'), format='PDF')
plt.savefig(os.path.join(plot_outdir, 'd27-x01-y07.png'), format='PNG')

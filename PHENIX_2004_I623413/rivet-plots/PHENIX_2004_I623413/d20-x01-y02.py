...
# Analysis object: /PHENIX_2004_I623413/d20-x01-y02
...
ax_title  = 'Invariant yields for $\\pi^-$ at 0-5$\\%$ centrality'
ax_xScale = 'linear'
ax_yScale = 'log'
xLims = (0.5, 3.0)
yLims = (9e-05, 1.1)
...
exec(open(prefix+'d20-x01-y02__data.py').read(), dataf)
...
plt.savefig(os.path.join(plot_outdir, 'd20-x01-y02.pdf'), format='PDF')
plt.savefig(os.path.join(plot_outdir, 'd20-x01-y02.png'), format='PNG')

...
# Analysis object: /PHENIX_2004_I623413/d14-x01-y01
...
ax_title  = 'Invariant yields of $p$ in each event at 60-92$\\%$ centrality'
ax_xScale = 'linear'
ax_yScale = 'log'
xLims = (0.5, 3.8)
...
exec(open(prefix+'d14-x01-y01__data.py').read(), dataf)
...
plt.savefig(os.path.join(plot_outdir, 'd14-x01-y01.pdf'), format='PDF')
plt.savefig(os.path.join(plot_outdir, 'd14-x01-y01.png'), format='PNG')

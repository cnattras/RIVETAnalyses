...
# Analysis object: /PHENIX_2004_I623413/d26-x01-y05
...
exec(open(prefix+'d26-x01-y05__data.py').read(), dataf)
...
plt.savefig(os.path.join(plot_outdir, 'd26-x01-y05.pdf'), format='PDF')
plt.savefig(os.path.join(plot_outdir, 'd26-x01-y05.png'), format='PNG')

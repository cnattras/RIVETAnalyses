...
# Analysis object: /PHENIX_2004_I623413/d21-x01-y01
...
exec(open(prefix+'d21-x01-y01__data.py').read(), dataf)
...
plt.savefig(os.path.join(plot_outdir, 'd21-x01-y01.pdf'), format='PDF')
plt.savefig(os.path.join(plot_outdir, 'd21-x01-y01.png'), format='PNG')

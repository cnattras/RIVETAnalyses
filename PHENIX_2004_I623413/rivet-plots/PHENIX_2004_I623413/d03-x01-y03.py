...
# Analysis object: /PHENIX_2004_I623413/d03-x01-y03
...
exec(open(prefix+'d03-x01-y03__data.py').read(), dataf)
...
plt.savefig(os.path.join(plot_outdir, 'd03-x01-y03.pdf'), format='PDF')
plt.savefig(os.path.join(plot_outdir, 'd03-x01-y03.png'), format='PNG')

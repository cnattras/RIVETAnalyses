...
# Analysis object: /PHENIX_2004_I623413/d25-x01-y01
...
ax_xLabel = 'Centrality ($\\%$)'
ax_yLabel = '$\\pi ^+$'
ax_title  = 'The $dN/dy$ at midrapidity for hadrons produced at midrapidity.'
ax_xScale = 'linear'
ax_yScale = 'log'
xLims = (0.2, 2.2)
...
exec(open(prefix+'d25-x01-y01__data.py').read(), dataf)
...
plt.savefig(os.path.join(plot_outdir, 'd25-x01-y01.pdf'), format='PDF')
plt.savefig(os.path.join(plot_outdir, 'd25-x01-y01.png'), format='PNG')

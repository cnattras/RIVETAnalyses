...
# Analysis object: /PHENIX_2004_I623413/d14-x01-y02
...
ax_title  = 'Invariant yields of $\\bar{p}$ in each event at 60-92$\\%$ centrality'
ax_xScale = 'linear'
ax_yScale = 'log'
xLims = (0.5, 3.8)
...
exec(open(prefix+'d14-x01-y02__data.py').read(), dataf)
...
plt.savefig(os.path.join(plot_outdir, 'd14-x01-y02.pdf'), format='PDF')
plt.savefig(os.path.join(plot_outdir, 'd14-x01-y02.png'), format='PNG')

  ...
  public:
    ...
    void init() {
      ...
      //Particles: K0S, Lambda, Xi-, Anti-Xi+, Omega-, Anti-Omega+, anti-Lambda(?)
    	...
    	const PrimaryParticles fs(pdgIds, Cuts::abscharge > 0 && Cuts::absrap < 1.8 && Cuts::abseta < 2.5);
    	declare(fs, "fs");
    	const PrimaryParticles ns(pdgIds, Cuts::abscharge == 0 && Cuts::absrap < 1.8 && Cuts::abseta < 5.2 && Cuts::abseta > 3);
    	declare(ns, "ns");
	...
	//Y_asym for 0.3<y_CM<0.8 in pPB (fig 6.1)
	//book(hYasymLowyCM["Yasym_K0S_pPB_0.3<yCM<0.8"], 10, 1, 1);
	//book(hYasymLowyCM["Yasym_Lambda_pPB_0.3<yCM<0.8"], 10, 1, 2);
	//book(hYasymLowyCM["Yasym_h+/-_pPB_0.3<yCM<0.8"], 10, 1, 3);
	
	//Y_asym for 0.8<y_CM<1.3 in pPB (fig 6.2)
	//book(hYasymMidyCM["Yasym_K0S_pPB_0.8<yCM<1.3"], 11, 1, 1);
	//book(hYasymMidyCM["Yasym_Lambda_pPB_0.8<yCM<1.3"], 11, 1, 2);
	//book(hYasymMidyCM["Yasym_h+/-_pPB_0.8<yCM<1.3"], 11, 1, 3);
	
	//Y_asym for 1.3<y_CM<1.8 in pPB (fig 6.3)
	//book(hYasymHighyCM["Yasym_K0S_pPB_1.3<yCM<1.8"], 12, 1, 1);
	//book(hYasymHighyCM["Yasym_Lambda_pPB_1.3<yCM<1.8"], 12, 1, 2);
	...
	book(hInvariantPTK0S["pT_K0S_pPB_-1.8<yCM<1.8"], refname1, "_-1.8<yCM<1.8", refdata1);
	book(hInvariantPTK0S["pT_K0S_pp_-1.8<yCM<1.8"], refname1, "_-1.8<yCM<1.8", refdata1);
	...
	book(hInvariantPTLambda["pT_Lambda_pPB_-1.8<yCM<1.8"], refname2, "_-1.8<yCM<1.8", refdata2);
	book(hInvariantPTLambda["pT_Lambda_pp_-1.8<yCM<1.8"], refname2, "_-1.8<yCM<1.8", refdata2);
	...
	book(hInvariantPTXi["pT_Xi_pPB_-1.8<yCM<1.8"], refname3, "_-1.8<yCM<1.8", refdata3);
	book(hInvariantPTXi["pT_Xi_pp_-1.8<yCM<1.8"], refname3, "_-1.8<yCM<1.8", refdata3);
	...
	book(hInvariantPTOmega["pT_Omega_pPB_-1.8<yCM<1.8"], refname4, "_-1.8<yCM<1.8", refdata4);
	book(hInvariantPTOmega["pT_Omega_pp_-1.8<yCM<1.8"], refname4, "_-1.8<yCM<1.8", refdata4);
	...
	book(hInvariantPTK0S["pT_K0S_pPB_-1.8<yCM<0"], refname5, "_-1.8<yCM<0", refdata5);
	book(hInvariantPTK0S["pT_K0S_pp_-1.8<yCM<0"], refname5, "_-1.8<yCM<0", refdata5);
	...
	book(hInvariantPTLambda["pT_Lambda_pPB_-1.8<yCM<0"], refname6, "_-1.8<yCM<0", refdata6);
	book(hInvariantPTLambda["pT_Lambda_pp_-1.8<yCM<0"], refname6, "_-1.8<yCM<0", refdata6);
	...
	book(hInvariantPTXi["pT_Xi_pPB_-1.8<yCM<0"], refname7, "_-1.8<yCM<0", refdata7);
	book(hInvariantPTXi["pT_Xi_pp_-1.8<yCM<0"], refname7, "_-1.8<yCM<0", refdata7);
	book(RpPBLowyCM["pPB_pT_Xi/pp_pT_Xi_low"], refname7);
	
	//R_pPB for 0<y_CM<1.8 in pPB (fig 4.2)
	string refname8 = mkAxisCode(7, 1, 1);
	const Scatter2D& refdata8 = refData(refname8);
	book(hInvariantPTK0S["pT_K0S_pPB_0<yCM<1.8"], refname8, "_0<yCM<1.8", refdata8);
	book(hInvariantPTK0S["pT_K0S_pp_0<yCM<1.8"], refname8, "_0<yCM<1.8", refdata8);
	...
	book(hInvariantPTLambda["pT_Lambda_pPB_0<yCM<1.8"], refname9, "_0<yCM<1.8", refdata9);
	book(hInvariantPTLambda["pT_Lambda_pp_0<yCM<1.8"], refname9, "_0<yCM<1.8", refdata9);
	...
	book(hInvariantPTXi["pT_Xi_pPB_0<yCM<1.8"], refname10, "_0<yCM<1.8", refdata10);
	book(hInvariantPTXi["pT_Xi_pp_0<yCM<1.8"], refname10, "_0<yCM<1.8", refdata10);
	...
	book(hInvariantPTK0SpPB["K0S_pT_pPB_-0.8<yCM<-0.3"], refname11, "_-0.8<yCM<-0.3", refdata11);
	book(hInvariantPTK0SpPB["K0S_pT_pPB_0.3<yCM<0.8"], refname11, "_0.3<yCM<0.8", refdata11);
	book(YasymLow["K0S_-0.8<yCM<-0.3/0.3<yCM<0.8"], refname11);
	
	string refname12 = mkAxisCode(11, 1, 1);
	const Scatter2D& refdata12 = refData(refname12);
	book(hInvariantPTLambdapPB["Lambda_pT_pPB_-0.8<yCM<-0.3"], refname12, "_-0.8<yCM<-0.3", refdata12);
	book(hInvariantPTLambdapPB["Lambda_pT_pPB_0.3<yCM<0.8"], refname12, "_0.3<yCM<0.8", refdata12);
	...
	book(h["negative_charged_yCM_-0.8<yCM<-0.3"], refname17, "_-0.8<yCM<-0.3", refdata17);
	book(h["positive_charged_yCM_0.3<yCM<0.8"], refname17, "_0.3<yCM<0.8", refdata17);
	book(YasymLow["h+/-_-0.8<yCM<-0.3/0.3<yCM<0.8"], refname17);
	
	//Y_asym for 0.8 < |yCM| < 1.3
	string refname13 = mkAxisCode(10, 1, 2);
	const Scatter2D& refdata13 = refData(refname13);
	book(hInvariantPTK0SpPB["K0S_pT_pPB_-1.3<yCM<-0.8"], refname13, "_-1.3<yCM<-0.8", refdata13);
	book(hInvariantPTK0SpPB["K0S_pT_pPB_0.8<yCM<1.3"], refname13, "_0.8<yCM<1.3", refdata13);
	...
	book(hInvariantPTLambdapPB["Lambda_pT_pPB_-1.3<yCM<-0.8"], refname14, "_-1.3<yCM<-0.8", refdata14);
	book(hInvariantPTLambdapPB["Lambda_pT_pPB_0.8<yCM<1.3"], refname14, "_0.8<yCM<1.3", refdata14);
	book(YasymMid["Lambda_-1.3<yCM<-0.8/0.8<yCM<1.3"], refname14);
	
	//Y_asym Mid for h+/-
	string refname18 = mkAxisCode(12, 1, 2);
	...
	string refname15 = mkAxisCode(10, 1, 3);
	const Scatter2D& refdata15 = refData(refname15);
	book(hInvariantPTK0SpPB["K0S_pT_pPB_-1.8<yCM<-1.3"], refname15, "_-1.8<yCM<-1.3", refdata15);
	book(hInvariantPTK0SpPB["K0S_pT_pPB_1.3<yCM<1.8"], refname15, "_1.3<yCM<1.8", refdata15);
	book(YasymHigh["K0S_-1.8<yCM<-1.3/1.3<yCM<1.8"], refname15);
	
	string refname16 = mkAxisCode(11, 1, 3);
	const Scatter2D& refdata16 = refData(refname16);
	book(hInvariantPTLambdapPB["Lambda_pT_pPB_-1.8<yCM<-1.3"], refname16, "_-1.8<yCM<-1.3", refdata16);
	book(hInvariantPTLambdapPB["Lambda_pT_pPB_1.3<yCM<1.8"], refname16, "_1.3<yCM<1.8", refdata16);
	...
	if (collSys == pPB)
	{
		...
		for (Particle p : neutralParticles)
		{
			double partPt = p.pT() / GeV;
			double pt_weight = 1. / (partPt * 2. * M_PI);
			double pt_weight_Ncoll = 1. / (partPt * 2. * M_PI *6.9);
			switch (p.pid()) {
			case 310: // K0S
			{
				hInvariantPTK0S["pT_K0S_pPB_-1.8<yCM<0"]->fill(partPt, pt_weight_Ncoll);
				hInvariantPTK0S["pT_K0S_pPB_-1.8<yCM<1.8"]->fill(partPt, pt_weight_Ncoll);
				hInvariantPTK0S["pT_K0S_pPB_0<yCM<1.8"]->fill(partPt, pt_weight_Ncoll);
				...
				//hYasymLowyCM["Yasym_K0S_pPB_0.3<yCM<0.8"]->fill(partPt);
				//hYasymMidyCM["Yasym_K0S_pPB_0.8<yCM<1.3"]->fill(partPt);
				//hYasymHighyCM["Yasym_K0S_pPB_1.3<yCM<1.8"]->fill(partPt);
			...
			case 3122: // Lambda
			{
				hInvariantPTLambda["pT_Lambda_pPB_-1.8<yCM<0"]->fill(partPt, pt_weight_Ncoll);
				hInvariantPTLambda["pT_Lambda_pPB_-1.8<yCM<1.8"]->fill(partPt, pt_weight_Ncoll);
				hInvariantPTLambda["pT_Lambda_pPB_0<yCM<1.8"]->fill(partPt, pt_weight_Ncoll);
				...
				//hYasymLowyCM["Yasym_Lambda_pPB_0.3<yCM<0.8"]->fill(partPt);
				//hYasymMidyCM["Yasym_Lambda_pPB_0.8<yCM<1.3"]->fill(partPt);
				//hYasymHighyCM["Yasym_Lambda_pPB_1.3<yCM<1.8"]->fill(partPt);
		...
		for (Particle p : chargedParticles)
		{
			...
			case 3312: // Xi-
			{
				hInvariantPTXi["pT_Xi_pPB_-1.8<yCM<0"]->fill(partPt, pt_weight_Ncoll);
				hInvariantPTXi["pT_Xi_pPB_-1.8<yCM<1.8"]->fill(partPt, pt_weight_Ncoll);
				hInvariantPTXi["pT_Xi_pPB_0<yCM<1.8"]->fill(partPt, pt_weight_Ncoll);
				...
				//hYasymLowyCM["Yasym_h+/-_pPB_0.3<yCM<0.8"]->fill(partPt);
				//hYasymMidyCM["Yasym_h+/-_pPB_0.8<yCM<1.3"]->fill(partPt);
				//hYasymHighyCM["Yasym_h+/-_pPB_1.3<yCM<1.8"]->fill(partPt);
			...
			case 3334: // Omega-
			{
				...
				hInvariantPTOmega["pT_Omega_pPB_-1.8<yCM<1.8"]->fill(partPt, pt_weight_Ncoll);
	...
	//*******Scale histograms*********
	hInvariantPTK0S["pT_K0S_pp_-1.8<yCM<0"]->scaleW(1. / sow["sow_pp"]->sumW());
	hInvariantPTK0S["pT_K0S_pp_-1.8<yCM<1.8"]->scaleW(1. / sow["sow_pp"]->sumW());
	hInvariantPTK0S["pT_K0S_pp_0<yCM<1.8"]->scaleW(1. / sow["sow_pp"]->sumW());
		
	//hInvariantPTK0S["pT_K0S_pp_full"]->scaleW(1. / sow["sow_pp"]->sumW());
	//hInvariantPTK0S["pT_K0S_pp_low"]->scaleW(1. / sow["sow_pp"]->sumW());
	//hInvariantPTK0S["pT_K0S_pp_high"]->scaleW(1. / sow["sow_pp"]->sumW());
				
	hInvariantPTLambda["pT_Lambda_pp_-1.8<yCM<0"]->scaleW(1. / sow["sow_pp"]->sumW());
	hInvariantPTLambda["pT_Lambda_pp_-1.8<yCM<1.8"]->scaleW(1. / sow["sow_pp"]->sumW());
	hInvariantPTLambda["pT_Lambda_pp_0<yCM<1.8"]->scaleW(1. / sow["sow_pp"]->sumW());	
		
	//hInvariantPTLambda["pT_Lambda_pp_full"]->scaleW(1. / sow["sow_pp"]->sumW());
	//hInvariantPTLambda["pT_Lambda_pp_low"]->scaleW(1. / sow["sow_pp"]->sumW());
	//hInvariantPTLambda["pT_Lambda_pp_high"]->scaleW(1. / sow["sow_pp"]->sumW());

	hInvariantPTXi["pT_Xi_pp_-1.8<yCM<0"]->scaleW(1. / sow["sow_pp"]->sumW());
	hInvariantPTXi["pT_Xi_pp_-1.8<yCM<1.8"]->scaleW(1. / sow["sow_pp"]->sumW());
	hInvariantPTXi["pT_Xi_pp_0<yCM<1.8"]->scaleW(1. / sow["sow_pp"]->sumW());
					
	//hInvariantPTXi["pT_Xi_pp_full"]->scaleW(1. / sow["sow_pp"]->sumW());
	//hInvariantPTXi["pT_Xi_pp_low"]->scaleW(1. / sow["sow_pp"]->sumW());
	//hInvariantPTXi["pT_Xi_pp_high"]->scaleW(1. / sow["sow_pp"]->sumW());

	hInvariantPTOmega["pT_Omega_pp_-1.8<yCM<0"]->scaleW(1. / sow["sow_pp"]->sumW());
	hInvariantPTOmega["pT_Omega_pp_-1.8<yCM<1.8"]->scaleW(1. / sow["sow_pp"]->sumW());
	hInvariantPTOmega["pT_Omega_pp_0<yCM<1.8"]->scaleW(1. / sow["sow_pp"]->sumW());	
		
	//hInvariantPTOmega["pT_Omega_pp_full"]->scaleW(1. / sow["sow_pp"]->sumW());
	//hInvariantPTOmega["pT_Omega_pp_low"]->scaleW(1. / sow["sow_pp"]->sumW());
	//hInvariantPTOmega["pT_Omega_pp_high"]->scaleW(1. / sow["sow_pp"]->sumW());
				
		
	hInvariantPTK0S["pT_K0S_pPB_-1.8<yCM<0"]->scaleW(1. / sow["sow_pPB"]->sumW());
	hInvariantPTK0S["pT_K0S_pPB_-1.8<yCM<1.8"]->scaleW(1. / sow["sow_pPB"]->sumW());
	hInvariantPTK0S["pT_K0S_pPB_0<yCM<1.8"]->scaleW(1. / sow["sow_pPB"]->sumW());
	
	hRpPBFullyCM["RpPB_K0S_-1.8<yCM<1.8"]->scaleW(1. / sow["sow_pPB"]->sumW());
	hRpPBLowyCM["RpPB_K0S_-1.8<yCM<0"]->scaleW(1. / sow["sow_pPB"]->sumW());
	hRpPBHighyCM["RpPB_K0S_0<yCM<1.8"]->scaleW(1. / sow["sow_pPB"]->sumW());
			
	hInvariantPTK0SpPB["pT_K0S_pPB_-1.8<yCM<-1.3"]->scaleW(1. / sow["sow_pPB"]->sumW());
	hInvariantPTK0SpPB["pT_K0S_pPB_-1.3<yCM<-0.8"]->scaleW(1. / sow["sow_pPB"]->sumW());
	hInvariantPTK0SpPB["pT_K0S_pPB_-0.8<yCM<-0.3"]->scaleW(1. / sow["sow_pPB"]->sumW());
	hInvariantPTK0SpPB["pT_K0S_pPB_0.3<yCM<0.8"]->scaleW(1. / sow["sow_pPB"]->sumW());
	hInvariantPTK0SpPB["pT_K0S_pPB_0.8<yCM<1.3"]->scaleW(1. / sow["sow_pPB"]->sumW());
	hInvariantPTK0SpPB["pT_K0S_pPB_1.3<yCM<1.8"]->scaleW(1. / sow["sow_pPB"]->sumW());
	
	//hYasymLowyCM["Yasym_K0S_pPB_0.3<yCM<0.8"]->scaleW(1. / sow["sow_pPB"]->sumW());
	//hYasymMidyCM["Yasym_K0S_pPB_0.8<yCM<1.3"]->scaleW(1. / sow["sow_pPB"]->sumW());
	//hYasymHighyCM["Yasym_K0S_pPB_1.3<yCM<1.8"]->scaleW(1. / sow["sow_pPB"]->sumW());
				
	//hInvariantPTK0S["pT_K0S_pPB_full"]->scaleW(1. / sow["sow_pPB"]->sumW());
	//hInvariantPTK0S["pT_K0S_pPB_low"]->scaleW(1. / sow["sow_pPB"]->sumW());
	//hInvariantPTK0S["pT_K0S_pPB_high"]->scaleW(1. / sow["sow_pPB"]->sumW());
	
	hInvariantPTLambda["pT_Lambda_pPB_-1.8<yCM<0"]->scaleW(1. / sow["sow_pPB"]->sumW());
	hInvariantPTLambda["pT_Lambda_pPB_-1.8<yCM<1.8"]->scaleW(1. / sow["sow_pPB"]->sumW());
	hInvariantPTLambda["pT_Lambda_pPB_0<yCM<1.8"]->scaleW(1. / sow["sow_pPB"]->sumW());
	
	hRpPBFullyCM["RpPB_Lambda_-1.8<yCM<1.8"]->scaleW(1. / sow["sow_pPB"]->sumW());
	hRpPBLowyCM["RpPB_Lambda_-1.8<yCM<0"]->scaleW(1. / sow["sow_pPB"]->sumW());
	hRpPBHighyCM["RpPB_Lambda_0<yCM<1.8"]->scaleW(1. / sow["sow_pPB"]->sumW());
				
	hInvariantPTLambdapPB["pT_Lambda_pPB_-1.8<yCM<-1.3"]->scaleW(1. / sow["sow_pPB"]->sumW());
	hInvariantPTLambdapPB["pT_Lambda_pPB_-1.3<yCM<-0.8"]->scaleW(1. / sow["sow_pPB"]->sumW());
	hInvariantPTLambdapPB["pT_Lambda_pPB_-0.8<yCM<-0.3"]->scaleW(1. / sow["sow_pPB"]->sumW());
	hInvariantPTLambdapPB["pT_Lambda_pPB_0.3<yCM<0.8"]->scaleW(1. / sow["sow_pPB"]->sumW());
	hInvariantPTLambdapPB["pT_Lambda_pPB_0.8<yCM<1.3"]->scaleW(1. / sow["sow_pPB"]->sumW());
	hInvariantPTLambdapPB["pT_Lambda_pPB_1.3<yCM<1.8"]->scaleW(1. / sow["sow_pPB"]->sumW());
	
	//hYasymLowyCM["Yasym_Lambda_pPB_0.3<yCM<0.8"]->scaleW(1. / sow["sow_pPB"]->sumW());
	//hYasymMidyCM["Yasym_Lambda_pPB_0.8<yCM<1.3"]->scaleW(1. / sow["sow_pPB"]->sumW());
	//hYasymHighyCM["Yasym_Lambda_pPB_1.3<yCM<1.8"]->scaleW(1. / sow["sow_pPB"]->sumW());
				
	//hInvariantPTLambda["pT_Lambda_pPB_full"]->scaleW(1. / sow["sow_pPB"]->sumW());
	//hInvariantPTLambda["pT_Lambda_pPB_low"]->scaleW(1. / sow["sow_pPB"]->sumW());
	//hInvariantPTLambda["pT_Lambda_pPB_high"]->scaleW(1. / sow["sow_pPB"]->sumW());
	
	hInvariantPTXi["pT_Xi_pPB_-1.8<yCM<0"]->scaleW(1. / sow["sow_pPB"]->sumW());
	hInvariantPTXi["pT_Xi_pPB_-1.8<yCM<1.8"]->scaleW(1. / sow["sow_pPB"]->sumW());
	hInvariantPTXi["pT_Xi_pPB_0<yCM<1.8"]->scaleW(1. / sow["sow_pPB"]->sumW());
				
	hRpPBFullyCM["RpPB_Xi_-1.8<yCM<1.8"]->scaleW(1. / sow["sow_pPB"]->sumW());
	hRpPBLowyCM["RpPB_Xi_-1.8<yCM<0"]->scaleW(1. / sow["sow_pPB"]->sumW());
	hRpPBHighyCM["RpPB_Xi_0<yCM<1.8"]->scaleW(1. / sow["sow_pPB"]->sumW());
				
	//hYasymLowyCM["Yasym_h+/-_pPB_0.3<yCM<0.8"]->scaleW(1. / sow["sow_pPB"]->sumW());
	//hYasymMidyCM["Yasym_h+/-_pPB_0.8<yCM<1.3"]->scaleW(1. / sow["sow_pPB"]->sumW());
	//hYasymHighyCM["Yasym_h+/-_pPB_1.3<yCM<1.8"]->scaleW(1. / sow["sow_pPB"]->sumW());
				
	//hInvariantPTXi["pT_Xi_pPB_full"]->scaleW(1. / sow["sow_pPB"]->sumW());
	//hInvariantPTXi["pT_Xi_pPB_low"]->scaleW(1. / sow["sow_pPB"]->sumW());
	//hInvariantPTXi["pT_Xi_pPB_high"]->scaleW(1. / sow["sow_pPB"]->sumW());
	...
	//hInvariantPTOmega["pT_Omega_pPB_full"]->scaleW(1. / sow["sow_pPB"]->sumW());
	...
	//hInvariantPTK0S["pT_K0S_pPB_-1.8<yCM<0"]->scaleY(1. / 6.9);
	//hInvariantPTK0S["pT_K0S_pPB_-1.8<yCM<1.8"]->scaleY(1. / 6.9);
	//hInvariantPTK0S["pT_K0S_pPB_0<yCM<1.8"]->scaleY(1. / 6.9);
	//hInvariantPTLambda["pT_Lambda_pPB_-1.8<yCM<0"]->scaleY(1. / 6.9);
	//hInvariantPTLambda["pT_Lambda_pPB_-1.8<yCM<1.8"]->scaleY(1. / 6.9);
	//hInvariantPTLambda["pT_Lambda_pPB_0<yCM<1.8"]->scaleY(1. / 6.9);
	//hInvariantPTXi["pT_Xi_pPB_-1.8<yCM<0"]->scaleY(1. / 6.9);
	//hInvariantPTXi["pT_Xi_pPB_-1.8<yCM<1.8"]->scaleY(1. / 6.9);
	//hInvariantPTXi["pT_Xi_pPB_0<yCM<1.8"]->scaleY(1. / 6.9);
	//hInvariantPTOmega["pT_Omega_pPB_-1.8<yCM<1.8"]->scaleY(1. / 6.9);
	...
	divide(hInvariantPTXi["pT_Xi_pPB_-1.8<yCM<0"], hInvariantPTXi["pT_Xi_pp_-1.8<yCM<0"], RpPBLowyCM["pPB_pT_Xi/pp_pT_Xi_low"]);
	divide(hInvariantPTXi["pT_Xi_pPB_-1.8<yCM<1.8"], hInvariantPTXi["pT_Xi_pp_-1.8<yCM<1.8"], RpPBHighyCM["pPB_pT_Xi/pp_pT_Xi_full"]);
	
	divide(hInvariantPTLambda["pT_Lambda_pPB_0<yCM<1.8"], hInvariantPTLambda["pT_Lambda_pp_0<yCM<1.8"], RpPBHighyCM["pPB_pT_Lambda/pp_pT_Lambda_high"]);
	divide(hInvariantPTLambda["pT_Lambda_pPB_-1.8<yCM<0"], hInvariantPTLambda["pT_Lambda_pp_-1.8<yCM<0"], RpPBHighyCM["pPB_pT_Lambda/pp_pT_Lambda_low"]);
	divide(hInvariantPTLambda["pT_Lambda_pPB_-1.8<yCM<1.8"], hInvariantPTLambda["pT_Lambda_pp_-1.8<yCM<1.8"], RpPBHighyCM["pPB_pT_Lambda/pp_pT_Lambda_full"]);
	
	divide(hInvariantPTK0S["pT_K0S_pPB_0<yCM<1.8"], hInvariantPTK0S["pT_K0S_pp_0<yCM<1.8"], RpPBHighyCM["pPB_pT_K0S/pp_pT_K0S_high"]);
	divide(hInvariantPTK0S["pT_K0S_pPB_-1.8<yCM<0"], hInvariantPTK0S["pT_K0S_pp_-1.8<yCM<0"], RpPBHighyCM["pPB_pT_K0S/pp_pT_K0S_low"]);
	divide(hInvariantPTK0S["pT_K0S_pPB_-1.8<yCM<1.8"], hInvariantPTK0S["pT_K0S_pp_-1.8<yCM<1.8"], RpPBHighyCM["pPB_pT_K0S/pp_pT_K0S_full"]);
	
	divide(hInvariantPTOmega["pT_Omega_pPB_-1.8<yCM<1.8"], hInvariantPTOmega["pT_Omega_pp_-1.8<yCM<1.8"], RpPBHighyCM["pPB_pT_Omega/pp_pT_Omega_full"]);
	
	divide(hInvariantPTK0SpPB["K0S_pT_pPB_-0.8<yCM<-0.3"], hInvariantPTK0SpPB["K0S_pT_pPB_0.3<yCM<0.8"], YasymLow["K0S_-0.8<yCM<-0.3/0.3<yCM<0.8"]);
	divide(hInvariantPTLambdapPB["Lambda_pT_pPB_-0.8<yCM<-0.3"], hInvariantPTLambdapPB["Lambda_pT_pPB_0.3<yCM<0.8"], YasymLow["Lambda_-0.8<yCM<-0.3/0.3<yCM<0.8"]);
	divide(h["negative_charged_yCM_low"], h["positive_charged_yCM_low"], YasymLow["h+/-_-0.8<yCM<-0.3/0.3<yCM<0.8"]);

	divide(hInvariantPTK0SpPB["K0S_pT_pPB_-1.3<yCM<-0.8"], hInvariantPTK0SpPB["K0S_pT_pPB_0.8<yCM<1.3"], YasymMid["K0S_-1.3<yCM<-0.8/0.8<yCM<1.3"]);
	divide(hInvariantPTLambdapPB["Lambda_pT_pPB_-1.3<yCM<-0.8"], hInvariantPTLambdapPB["Lambda_pT_pPB_0.8<yCM<1.3"], YasymMid["Lambda_-1.3<yCM<-0.8/0.8<yCM<1.3"]);
	divide(h["negative_charged_yCM_mid"], h["positive_charged_yCM_mid"], YasymMid["h+/-_-1.3<yCM<-0.8/0.8<yCM<1.3"]);
	
	divide(hInvariantPTK0SpPB["K0S_pT_pPB_-1.8<yCM<-1.3"], hInvariantPTK0SpPB["K0S_pT_pPB_1.3<yCM<1.8"], YasymHigh["K0S_-1.8<yCM<-1.3/1.3<yCM<1.8"]);
	divide(hInvariantPTLambdapPB["Lambda_pT_pPB_-1.8<yCM<-1.3"], hInvariantPTLambdapPB["Lambda_pT_pPB_1.3<yCM<1.8"], YasymHigh["Lambda_-1.8<yCM<-1.3/1.3<yCM<1.8"]);
	divide(h["negative_charged_yCM_high"], h["positive_charged_yCM_high"], YasymHigh["h+/-_-1.8<yCM<-1.3/1.3<yCM<1.8"]);
    	...
    	map<string, Histo1DPtr> hYasymLowyCM;
    	map<string, Histo1DPtr> hYasymMidyCM;
    	map<string, Histo1DPtr> hYasymHighyCM;

...
namespace Rivet {
	...
	/// Constructor
	RIVET_DEFAULT_ANALYSIS_CTOR(PHENIX_2004_I624474);
	...
	//____Rcp____
	string dontplotme = "_";//Any plot which starts with this does not get plotted

	string refnameRcpPi = mkAxisCode(21,1,1);
	const Estimate1D& refdataRcpPi = refData(refnameRcpPi);
	book(hPi["AUAU0_10"], dontplotme+refnameRcpPi + "_0_10Pion", refdataRcpPi);
	book(hPi["AUAU60_92"], dontplotme+refnameRcpPi + "_60_92Pion", refdataRcpPi);
	book(hRcp["Pions"], refnameRcpPi);

	string refnameRcpK = mkAxisCode(22,1,1);
	const Estimate1D& refdataRcpK = refData(refnameRcpK);
	book(hK["AUAU0_10"], dontplotme+refnameRcpK + "_0_10Kaon", refdataRcpK);
	book(hK["AUAU60_92"], dontplotme+refnameRcpK + "_60_92Kaon", refdataRcpK);
	book(hRcp["Kaons"], refnameRcpK);

	string refnameRcpP = mkAxisCode(23,1,1);
	const Estimate1D& refdataRcpP = refData(refnameRcpP);
	book(hP["AUAU0_10"], dontplotme+refnameRcpP + "_0_10Proton", refdataRcpP);
	book(hP["AUAU60_92"], dontplotme+refnameRcpP + "_60_92Proton", refdataRcpP);
	book(hRcp["Pbar+P"], refnameRcpP);

	string refnameRcpPi0 = mkAxisCode(24,1,1);
	const Estimate1D& refdataRcpPi0 = refData(refnameRcpPi0);
	book(hPi0["AUAU0_10"], dontplotme+refnameRcpPi0 + "_0_10Pion0", refdataRcpPi0);
	book(hPi0["AUAU60_92"], dontplotme+refnameRcpPi0 + "_60_92Pion0", refdataRcpPi0);
	book(hRcp["Pi0"], refnameRcpPi0);
	
	//____ Rcp 1.5GeV+____
	
	string refnameRcpPi1_5 = mkAxisCode(25,1,1);
	const Estimate1D& refdataRcpPi1_5 = refData(refnameRcpPi1_5);
	book(hPi["AUAU0_10GeV1_5"], dontplotme+refnameRcpPi1_5 + "_0_10Pion1_5", refdataRcpPi1_5);
	book(hPi["AUAU60_92GeV1_5"], dontplotme+refnameRcpPi1_5 + "_60_92Pion1_5", refdataRcpPi1_5);
	...
	const Estimate1D& refdataRcpK1_5 = refData(refnameRcpK1_5);
	book(hK["AUAU0_10GeV1_5"], dontplotme+refnameRcpK1_5 + "_0_10Kaon1_5", refdataRcpK1_5);
	book(hK["AUAU60_92GeV1_5"], dontplotme+refnameRcpK1_5 + "_60_92Kaon1_5", refdataRcpK1_5);
	book(hRcp["Kaons1_5"], refnameRcpK1_5);

	string refnameRcpP1_5 = mkAxisCode(25,1,3);
	const Estimate1D& refdataRcpP1_5 = refData(refnameRcpP1_5);
	book(hP["AUAU0_10GeV1_5"], dontplotme+refnameRcpP1_5 + "_0_10Proton1_5", refdataRcpP1_5);
	book(hP["AUAU60_92GeV1_5"], dontplotme+refnameRcpP1_5 + "_60_92Proton1_5", refdataRcpP1_5);
	...
	const Estimate1D& refdataratio0_5PiPi = refData(refnameratio0_5PiPi);
	book(hPiPi["AUAU0_5Piminus"], dontplotme+refnameratio0_5PiPi + "_0_5Piminus", refdataratio0_5PiPi);
	book(hPiPi["AUAU0_5Piplus"], dontplotme+refnameratio0_5PiPi + "_0_5Piplus", refdataratio0_5PiPi);
	book(hRatio["Piminus_Piplus0_5"], refnameratio0_5PiPi);

	string refnameratio60_92PiPi = mkAxisCode(14,1,2);
	const Estimate1D& refdataratio60_92PiPi = refData(refnameratio60_92PiPi);
	book(hPiPi["AUAU60_92Piminus"], dontplotme+refnameratio60_92PiPi + "_60_92Piminus", refdataratio60_92PiPi);
	book(hPiPi["AUAU60_92Piplus"], dontplotme+refnameratio60_92PiPi + "_60_92Piplus", refdataratio60_92PiPi);
	book(hRatio["Piminus_Piplus60_92"], refnameratio60_92PiPi);

	string refnameratio0_5KK = mkAxisCode(15,1,1);	//Kaon-/Kaon+
	const Estimate1D& refdataratio0_5KK = refData(refnameratio0_5KK);
	book(hKK["AUAU0_5Kminus"], dontplotme+refnameratio0_5KK + "_0_5Kminus", refdataratio0_5KK);
	book(hKK["AUAU0_5Kplus"], dontplotme+refnameratio0_5KK + "_0_5Kplus", refdataratio0_5KK);
	book(hRatio["Kiminus_Kiplus0_5"], refnameratio0_5KK);

	string refnameratio60_92KK = mkAxisCode(15,1,2);
	const Estimate1D& refdataratio60_92KK = refData(refnameratio60_92KK);
	book(hKK["AUAU60_92Kminus"], dontplotme+refnameratio60_92KK + "_60_92Kminus", refdataratio60_92KK);
	book(hKK["AUAU60_92Kplus"], dontplotme+refnameratio60_92KK + "_60_92Kplus", refdataratio60_92KK);
	book(hRatio["Kiminus_Kiplus60_92"], refnameratio60_92KK);

	string refnameratio0_5PbarP = mkAxisCode(16,1,1);	//Antiproton/Proton
	const Estimate1D& refdataratio0_5PbarP = refData(refnameratio0_5PbarP);
	book(hPP["AUAU0_5Pbar"], dontplotme+refnameratio0_5PbarP + "_0_5Pbar", refdataratio0_5PbarP);
	book(hPP["AUAU0_5P"], dontplotme+refnameratio0_5PbarP + "_0_5P", refdataratio0_5PbarP);
	book(hRatio["Pbar_P0_5"], refnameratio0_5PbarP);

	string refnameratio60_92PbarP = mkAxisCode(16,1,2);
	const Estimate1D& refdataratio60_92PbarP = refData(refnameratio60_92PbarP);
	book(hPP["AUAU60_92Pbar"], dontplotme+refnameratio60_92PbarP + "_60_92Pbar", refdataratio60_92PbarP);
	book(hPP["AUAU60_92P"], dontplotme+refnameratio60_92PbarP + "_60_92P", refdataratio60_92PbarP);
	book(hRatio["Pbar_P60_92"], refnameratio60_92PbarP);

	string refnameratiominPbarP = mkAxisCode(16,1,3);
	const Estimate1D& refdataratiominPbarP = refData(refnameratiominPbarP);
	book(hPP["AUAUminPbar"], dontplotme+refnameratiominPbarP + "_minPbar", refdataratiominPbarP);
	book(hPP["AUAUminP"], dontplotme+refnameratiominPbarP + "_minP", refdataratiominPbarP);
	book(hRatio["Pbar_Pmin"], refnameratiominPbarP);

	string refnameratio0_5KplusPiplus = mkAxisCode(17,1,1);	//Kaon+/Pi+
	const Estimate1D& refdataratio0_5KplusPiplus = refData(refnameratio0_5KplusPiplus);
	book(hKPi["AUAU0_5Kplus"], dontplotme+refnameratio0_5KplusPiplus + "_0_5Kplus", refdataratio0_5KplusPiplus);
	book(hKPi["AUAU0_5Piplus"], dontplotme+refnameratio0_5KplusPiplus + "_0_5Piplus", refdataratio0_5KplusPiplus);
	book(hRatio["Kplus_Piplus0_5"], refnameratio0_5KplusPiplus);

	string refnameratio60_92KplusPiplus = mkAxisCode(17,1,2);
	const Estimate1D& refdataratio60_92KplusPiplus = refData(refnameratio60_92KplusPiplus);
	book(hKPi["AUAU60_92Kplus"], dontplotme+refnameratio60_92KplusPiplus + "_60_92Kplus", refdataratio60_92KplusPiplus);
	book(hKPi["AUAU60_92Piplus"], dontplotme+refnameratio60_92KplusPiplus + "_60_92Piplus", refdataratio60_92KplusPiplus);
	book(hRatio["Kplus_Piplus60_92"], refnameratio60_92KplusPiplus);
	
	string refnameratio0_5KminusPiminus = mkAxisCode(17,1,3);	//Kaon-/Pi-
	const Estimate1D& refdataratio0_5KminusPiminus = refData(refnameratio0_5KminusPiminus);
	book(hKPi["AUAU0_5Kminus"], dontplotme+refnameratio0_5KminusPiminus + "_0_5Kminus", refdataratio0_5KminusPiminus);
	book(hKPi["AUAU0_5Piminus"], dontplotme+refnameratio0_5KminusPiminus + "_0_5Piminus", refdataratio0_5KminusPiminus);
	book(hRatio["Kminus_Piminus0_5"], refnameratio0_5KminusPiminus);

	string refnameratio60_92KminusPiminus = mkAxisCode(17,1,4);
	const Estimate1D& refdataratio60_92KminusPiminus = refData(refnameratio60_92KminusPiminus);
	book(hKPi["AUAU60_92Kminus"], dontplotme+refnameratio60_92KminusPiminus + "_60_92Kminus", refdataratio60_92KminusPiminus);
	book(hKPi["AUAU60_92Piminus"], dontplotme+refnameratio60_92KminusPiminus + "_60_92Piminus", refdataratio60_92KminusPiminus);
	book(hRatio["Kminus_Piminus60_92"], refnameratio60_92KminusPiminus);

	string refnameratio0_10PPiplus = mkAxisCode(18,1,1);	//Proton/Pi+
	const Estimate1D& refdataratio0_10PPiplus = refData(refnameratio0_10PPiplus);
	book(hPPi["AUAU0_10ProtonPiplus"], dontplotme+refnameratio0_10PPiplus + "_0_10P", refdataratio0_10PPiplus);
	book(hPPi["AUAU0_10Piplus"], dontplotme+refnameratio0_10PPiplus + "_0_10Piplus", refdataratio0_10PPiplus);
	book(hRatio["P_Piplus0_10"], refnameratio0_10PPiplus);

	string refnameratio20_30PPiplus = mkAxisCode(18,1,2);
	const Estimate1D& refdataratio20_30PPiplus = refData(refnameratio20_30PPiplus);
	book(hPPi["AUAU20_30ProtonPiplus"], dontplotme+refnameratio20_30PPiplus + "_20_30P", refdataratio20_30PPiplus);
	book(hPPi["AUAU20_30Piplus"], dontplotme+refnameratio20_30PPiplus + "_20_30Piplus", refdataratio20_30PPiplus);
	book(hRatio["P_Piplus20_30"], refnameratio20_30PPiplus);

	string refnameratio60_92PPiplus = mkAxisCode(18,1,3);
	const Estimate1D& refdataratio60_92PPiplus = refData(refnameratio60_92PPiplus);
	book(hPPi["AUAU60_92ProtonPiplus"], dontplotme+refnameratio60_92PPiplus + "_60_92P", refdataratio60_92PPiplus);
	book(hPPi["AUAU60_92Piplus"], dontplotme+refnameratio60_92PPiplus + "_60_92Piplus", refdataratio60_92PPiplus);
	book(hRatio["P_Piplus60_92"], refnameratio60_92PPiplus);
	
	string refnameratio0_10PbarPiminus = mkAxisCode(18,1,4);	//Antiproton/Pi-
	const Estimate1D& refdataratio0_10PbarPiminus = refData(refnameratio0_10PbarPiminus);
	book(hPPi["AUAU0_10PbarPiminus"], dontplotme+refnameratio0_10PbarPiminus + "_0_10Pbar", refdataratio0_10PbarPiminus);
	book(hPPi["AUAU0_10Piminus"], dontplotme+refnameratio0_10PbarPiminus + "_0_10Piminus", refdataratio0_10PbarPiminus);
	book(hRatio["Pbar_Piminus0_10"], refnameratio0_10PbarPiminus);

	string refnameratio20_30PbarPiminus = mkAxisCode(18,1,5);
	const Estimate1D& refdataratio20_30PbarPiminus = refData(refnameratio20_30PbarPiminus);
	book(hPPi["AUAU20_30PbarPiminus"], dontplotme+refnameratio20_30PbarPiminus + "_20_30Pbar", refdataratio20_30PbarPiminus);
	book(hPPi["AUAU20_30Piminus"], dontplotme+refnameratio20_30PbarPiminus + "_20_30Piminus", refdataratio20_30PbarPiminus);
	book(hRatio["Pbar_Piminus20_30"], refnameratio20_30PbarPiminus);

	string refnameratio60_92PbarPiminus = mkAxisCode(18,1,6);
	const Estimate1D& refdataratio60_92PbarPiminus = refData(refnameratio60_92PbarPiminus);
	book(hPPi["AUAU60_92PbarPiminus"], dontplotme+refnameratio60_92PbarPiminus + "_60_92Pbar", refdataratio60_92PbarPiminus);
	book(hPPi["AUAU60_92Piminus"], dontplotme+refnameratio60_92PbarPiminus + "_60_92Piminus", refdataratio60_92PbarPiminus);
	book(hRatio["Pbar_Piminus60_92"], refnameratio60_92PbarPiminus);

	string refnameratio0_10PPi0 = mkAxisCode(19,1,1);	//Proton/Pi0
	const Estimate1D& refdataratio0_10PPi0 = refData(refnameratio0_10PPi0);
	book(hPPi["AUAU0_10P"], dontplotme+refnameratio0_10PPi0 + "_0_10P", refdataratio0_10PPi0);
	book(hPPi["AUAU0_10PPi0"], dontplotme+refnameratio0_10PPi0 + "_0_10Pi0", refdataratio0_10PPi0);
	book(hRatio["P_Pi00_10"], refnameratio0_10PPi0);

	string refnameratio20_30PPi0 = mkAxisCode(19,1,2);
	const Estimate1D& refdataratio20_30PPi0 = refData(refnameratio20_30PPi0);
	book(hPPi["AUAU20_30P"], dontplotme+refnameratio20_30PPi0 + "_20_30P", refdataratio20_30PPi0);
	book(hPPi["AUAU20_30PPi0"], dontplotme+refnameratio20_30PPi0 + "_20_30Pi0", refdataratio20_30PPi0);
	book(hRatio["P_Pi020_30"], refnameratio20_30PPi0);

	string refnameratio60_92PPi0 = mkAxisCode(19,1,3);
	const Estimate1D& refdataratio60_92PPi0 = refData(refnameratio60_92PPi0);
	book(hPPi["AUAU60_92P"], dontplotme+refnameratio60_92PPi0 + "_60_92P", refdataratio60_92PPi0);
	book(hPPi["AUAU60_92PPi0"], dontplotme+refnameratio60_92PPi0 + "_60_92Pi0", refdataratio60_92PPi0);
	book(hRatio["P_Pi060_92"], refnameratio60_92PPi0);
	
	string refnameratio0_10PbarPi0 = mkAxisCode(19,1,4);	//Antiproton/Pi0
	const Estimate1D& refdataratio0_10PbarPi0 = refData(refnameratio0_10PbarPi0);
	book(hPPi["AUAU0_10Pbar"], dontplotme+refnameratio0_10PbarPi0 + "_0_10Pbar", refdataratio0_10PbarPi0);
	book(hPPi["AUAU0_10PbarPi0"], dontplotme+refnameratio0_10PbarPi0 + "_0_10Pi0", refdataratio0_10PbarPi0);
	book(hRatio["Pbar_Pi00_10"], refnameratio0_10PbarPi0);

	string refnameratio20_30PbarPi0 = mkAxisCode(19,1,5);
	const Estimate1D& refdataratio20_30PbarPi0 = refData(refnameratio20_30PbarPi0);
	book(hPPi["AUAU20_30Pbar"], dontplotme+refnameratio20_30PbarPi0 + "_20_30Pbar", refdataratio20_30PbarPi0);
	book(hPPi["AUAU20_30PbarPi0"], dontplotme+refnameratio20_30PbarPi0 + "_20_30Pi0", refdataratio20_30PbarPi0);
	book(hRatio["Pbar_Pi020_30"], refnameratio20_30PbarPi0);

	string refnameratio60_92PbarPi0 = mkAxisCode(19,1,6);
	const Estimate1D& refdataratio60_92PbarPi0 = refData(refnameratio60_92PbarPi0);
	book(hPPi["AUAU60_92Pbar"], dontplotme+refnameratio60_92PbarPi0 + "_60_92Pbar", refdataratio60_92PbarPi0);
	book(hPPi["AUAU60_92PbarPi0"], dontplotme+refnameratio60_92PbarPi0 + "_60_92Pi0", refdataratio60_92PbarPi0);
	...
	const Estimate1D& refdataPiminusPiplus = refData(refnamePiminusPiplus);
	book(hPiPi["AUAUPiminus"], dontplotme+refnamePiminusPiplus + "Piminus", refdataPiminusPiplus);
	book(hPiPi["AUAUPiplus"], dontplotme+refnamePiminusPiplus + "Piplus", refdataPiminusPiplus);
	book(hRatio["PiminusPiplus"], refnamePiminusPiplus);

	string refnameKminusKplus = mkAxisCode(20,1,2);		//K-/K+
	const Estimate1D& refdataKminusKplus = refData(refnameKminusKplus);
	book(hKK["AUAUKminus"], dontplotme+refnameKminusKplus + "Kminus", refdataKminusKplus);
	book(hKK["AUAUKplus"], dontplotme+refnameKminusKplus + "Kplus", refdataKminusKplus);
	book(hRatio["KminusKplus"], refnameKminusKplus);

	string refnamePbarP = mkAxisCode(20,1,3);
	const Estimate1D& refdataPbarP = refData(refnamePbarP);	//Antiproton/Proton
	book(hPP["AUAUPbar"], dontplotme+refnamePbarP + "Pbar", refdataPbarP);
	book(hPP["AUAUP"], dontplotme+refnamePbarP + "P", refdataPbarP);
	book(hRatio["PbarP"], refnamePbarP);

	string refnameKplusPiplus = mkAxisCode(20,1,4);		//K+/Pi+
	const Estimate1D& refdataKplusPiplus = refData(refnameKplusPiplus);
	book(hKPi["AUAUKplus"], dontplotme+refnameKplusPiplus + "Kplus", refdataKplusPiplus);
	book(hKPi["AUAUPiplus"], dontplotme+refnameKplusPiplus + "Piplus", refdataKplusPiplus);
	book(hRatio["KplusPiplus"], refnameKplusPiplus);

	string refnameKminusPiminus = mkAxisCode(20,1,5);	//K-/Pi-
	const Estimate1D& refdataKminusPiminus = refData(refnameKminusPiminus);
	book(hKPi["AUAUKminus"], dontplotme+refnameKminusPiminus + "Kminus", refdataKminusPiminus);
	book(hKPi["AUAUPiminus"], dontplotme+refnameKminusPiminus + "Piminus", refdataKminusPiminus);
	book(hRatio["KminusPiminus"], refnameKminusPiminus);

	string refnamePPiplus = mkAxisCode(20,1,6);		//Proton/Pi+
	const Estimate1D& refdataPPiplus = refData(refnamePPiplus);
	book(hPPi["AUAUP"], dontplotme+refnamePPiplus + "P", refdataPPiplus);
	book(hPPi["AUAUPiplus"], dontplotme+refnamePPiplus + "Pi", refdataPPiplus);
	book(hRatio["PPiplus"], refnamePPiplus);

	string refnamePbarPiminus = mkAxisCode(20,1,7);		//Antiproton/Pi-
	const Estimate1D& refdataPbarPiminus = refData(refnamePbarPiminus);
	book(hPPi["AUAUPbar"], dontplotme+refnamePbarPiminus + "Pbar", refdataPbarPiminus);
	book(hPPi["AUAUPiminus"], dontplotme+refnamePbarPiminus + "Pi", refdataPbarPiminus);
	...
	void analyze(const Event& event) {
		...
		sow["sow_AUAUall"]->fill();
			...
			for (const Particle& p : chargedParticles) {
				if (p.pT() > 1.5) {
					double centbins[] = {2.5,7.5,12.5,17.5,25,35,45,55,70};
					int ncentbins = 9;
					switch(abs(p.pid())) {
			
						case 211:	//pi+/-
						
							hPi["AUAU0_10GeV1_5"]->fill(c);	//Rcp numerator for Pions above 1.5GeV
							
							if ((c >= 60.) && (c <= 92.2)) {for(int i=0;i<ncentbins;i++) hPi["AUAU60_92GeV1_5"]->fill(centbins[i]);}	//Rcp denominator for Pions above 1.5GeV
						
							break;

						case 321:	//K+/-
	
							hK["AUAU0_10GeV1_5"]->fill(c);	//Rcp numerator for Kaons above 1.5GeV
							
							if ((c >= 60.) && (c <= 92.2)) {for(int i=0;i<ncentbins;i++) hK["AUAU60_92GeV1_5"]->fill(centbins[i]);}	//Rcp denominator for Pions above 1.5GeV
						
							break;

						case 2212:	//(anti)proton

							hP["AUAU0_10GeV1_5"]->fill(c);	//Rcp numerator for Protons above 1.5GeV
							
							if ((c >= 60.) && (c <= 92.2)) {for(int i=0;i<ncentbins;i++) hP["AUAU60_92GeV1_5"]->fill(centbins[i]);}	//Rcp denominator for Pions above 1.5GeV
		...
		if ((c >= 60.) && (c <= 92.2)) {
			...
			for (const Particle& p : chargedParticles) {
				...
				// if (partPt > 1.5) {
				// cout<<"High pT particle in peripheral collisions, type "<<p.pid()<<endl;
				// 	switch(p.pid()) {
			
				// 		case 211:	//pi+
						
				// 			hPi["AUAU60_92GeV1_5"]->fill(c);	//Rcp denominator for Pions above 1.5GeV
				...
				// 			hK["AUAU60_92GeV1_5"]->fill(c);	//Rcp denominator for Kaons above 1.5GeV
				...
				// 			hP["AUAU60_92GeV1_5"]->fill(c);	//Rcp denominator for Protons above 1.5GeV
...
//For the RCP, we have to scale by Ncoll[60-92%]/Ncoll[0-5%] = [14.5]/1065.4 =0.013609912
		...
		// }
		int i=0;
		for (auto& bin : hRcp["Pions1_5"]->bins()) {
 		 bin.scale(scales[8]/scales[i]);
 		 	i++;
		}
		i=0;
		for (auto& bin : hRcp["Kaons1_5"]->bins()) {
 		 bin.scale(scales[8]/scales[i]);
			i++;
		}
		i=0;
		for (auto& bin : hRcp["Pbar+P1_5"]->bins()) {
 		 bin.scale(scales[8]/scales[i]);
			i++;
		}
...
//		hPiPi["AUAU0_5Kplus"]->scaleW(1./sow["sow_AUAU5"]->sumW());
	...
	map<string, Estimate1DPtr> hRatio;
	...
	RIVET_DECLARE_PLUGIN(PHENIX_2004_I624474);
}

...
mkfifo AuAu14GeV.hepmc 
cat AuAu14GeV.hepmc > /dev/null &

pythia8-main144 -c AuAu14GeV.cmnd -c main144HepMC.cmnd -c main144Rivet.cmnd -o AuAu14GeV

pkill -f "cat AuAu14GeV.hepmc"
rm -f AuAu14GeV.hepmc

...
mkfifo AuAu200.hepmc 
cat AuAu200.hepmc > /dev/null &

pythia8-main144 -c AuAu200.cmnd -c main144HepMC.cmnd -c main144Rivet.cmnd -o AuAu200

pkill -f "cat AuAu200.hepmc"
rm -f AuAu200.hepmc

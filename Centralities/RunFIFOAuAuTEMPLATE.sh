...
mkfifo TEMPLATE.hepmc 
cat TEMPLATE.hepmc > /dev/null &

pythia8-main144 -c TEMPLATE.cmnd -c main144HepMC.cmnd -c main144Rivet.cmnd -o TEMPLATE

pkill -f "cat TEMPLATE.hepmc"
rm -f TEMPLATE.hepmc

...
setenv ANALYSES "PHENIX_2020_I1798493:cent=GEN"
...
setenv COMMAND "/direct/phenix+u/cen/pythia8244/examples/./main117 /tmp $FIFOFILE $2 $3 $4 $5 $6 $7 $8 & rivet --pwd -p $CENTCALIBRATION -a $ANALYSES -o $OUTFILE /tmp/$FIFOFILE"
echo $COMMAND
/direct/phenix+u/cen/pythia8244/examples/./main117 /tmp $FIFOFILE $2 $3 $4 $5 $6 $7 $8 & rivet --pwd -p $CENTCALIBRATION -a $ANALYSES -o $OUTFILE /tmp/$FIFOFILE
mv $OUTFILE $1/.
date

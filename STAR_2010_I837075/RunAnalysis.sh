...
rivet  --pwd -p ../Centralities/Calibration/calibration_STAR_CuCu200GeV.yoda -a STAR_2010_I837075:cent=GEN:beam=CUCU200 -o Rivet.yoda ../testfiles/PYTHIAAuAuFileSMALLTEST.dat

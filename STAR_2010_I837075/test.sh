...
rivet  --pwd -p ../Centralities/Calibration/calibration_STAR_AuAu200GeV.yoda -a STAR_2010_I837075:cent=GEN:beam=AuAu200 -o Rivet.yoda ../testfiles/PYTHIAAuAuFileSMALLTEST.dat

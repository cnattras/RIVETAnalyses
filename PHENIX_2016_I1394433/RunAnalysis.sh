...
rivet --pwd -p Centralities/Calibration/calibration_PHENIX_AuAu200GeV.yoda -a PHENIX_2016_I1394433:cent=GEN -o Rivet_AUAU_200.yoda ../testfiles/PYTHIAAuAuFileSMALLTEST.dat

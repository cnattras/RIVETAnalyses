...
rivet --pwd -p ../Centralities/Calibration/calibration_AuAu_200GeV_STAR.yoda -a STAR_2009_I793126:cent=GEN:beam=AUAU130 -o Rivet_AUAU130.yoda ../testfiles/PYTHIAAuAuFileSMALLTEST.dat

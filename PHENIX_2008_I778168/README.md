...
Arthur 5/27: R_AA vs Centrality is not binned right. Properly scaling said  R_AA calculation will need to be done over a loop of N^pp_(cent)/N^AA_(cent) and 1/N_(binary). Christine Plz help

...
void binShift(YODA::Histo1D& histogram) {
    ...
    for (auto& bins : binlist) {
		...
		void init() {
			...
			const Estimate1D& refdataRaaEta0_5 = refData(refnameRaaEta0_5);
			book(hEta["AUAUyield0_5"],"_" + refnameRaaEta0_5 + "_0_5Eta", refdataRaaEta0_5);
			book(hEta["PPcross0_5"],"_" + refnameRaaEta0_5 + "_0_5Pcross", refdataRaaEta0_5);
			book(sRaa["RaaEta0_5"], refnameRaaEta0_5);

			string refnameRaaEta0_10 = mkAxisCode(12,1,1);
			const Estimate1D& refdataRaaEta0_10 = refData(refnameRaaEta0_10);
			book(hEta["AUAUyield0_10"],"_" + refnameRaaEta0_10 + "_0_10Eta", refdataRaaEta0_10);
			book(hEta["PPcross0_10"],"_" + refnameRaaEta0_10 + "_0_10Pcross", refdataRaaEta0_10);
			book(sRaa["RaaEta0_10"], refnameRaaEta0_10);
	
			string refnameRaaEta10_20 = mkAxisCode(13,1,1);
			const Estimate1D& refdataRaaEta10_20 = refData(refnameRaaEta10_20);
			book(hEta["AUAUyield10_20"],"_" + refnameRaaEta10_20 + "_10_20Eta", refdataRaaEta10_20);
			book(hEta["PPcross10_20"],"_" + refnameRaaEta10_20 + "_10_20Pcross", refdataRaaEta10_20);
			book(sRaa["RaaEta10_20"], refnameRaaEta10_20);

			string refnameRaaEta0_20 = mkAxisCode(14,1,1);
			const Estimate1D& refdataRaaEta0_20 = refData(refnameRaaEta0_20);
			book(hEta["AUAUyield0_20"],"_" + refnameRaaEta0_20 + "_0_20Eta", refdataRaaEta0_20);
			book(hEta["PPcross0_20"],"_" + refnameRaaEta0_20 + "_0_20Pcross", refdataRaaEta0_20);
			book(sRaa["RaaEta0_20"], refnameRaaEta0_20);

			string refnameRaaEta20_40 = mkAxisCode(15,1,1);
			const Estimate1D& refdataRaaEta20_40 = refData(refnameRaaEta20_40);
			book(hEta["AUAUyield20_40"],"_" + refnameRaaEta20_40 + "_20_40Eta", refdataRaaEta20_40);
			book(hEta["PPcross20_40"],"_" + refnameRaaEta20_40 + "_20_40Pcross", refdataRaaEta20_40);
			book(sRaa["RaaEta20_40"], refnameRaaEta20_40);

			string refnameRaaEta40_60 = mkAxisCode(16,1,1);
			const Estimate1D& refdataRaaEta40_60 = refData(refnameRaaEta40_60);
			book(hEta["AUAUyield40_60"],"_" + refnameRaaEta40_60 + "_40_60Eta", refdataRaaEta40_60);
			book(hEta["PPcross40_60"],"_" + refnameRaaEta40_60 + "_40_60Pcross", refdataRaaEta40_60);
			book(sRaa["RaaEta40_60"], refnameRaaEta40_60);

			string refnameRaaEta20_60 = mkAxisCode(17,1,1);
			const Estimate1D& refdataRaaEta20_60 = refData(refnameRaaEta20_60);
			book(hEta["AUAUyield20_60"],"_" + refnameRaaEta20_60 + "_20_60Eta", refdataRaaEta20_60);
			book(hEta["PPcross20_60"],"_" + refnameRaaEta20_60 + "_20_60Pcross", refdataRaaEta20_60);
			book(sRaa["RaaEta20_60"], refnameRaaEta20_60);

			string refnameRaaEta60_92 = mkAxisCode(18,1,1);
			const Estimate1D& refdataRaaEta60_92 = refData(refnameRaaEta60_92);
			book(hEta["AUAUyield60_92"],"_" + refnameRaaEta60_92 + "_60_92Eta", refdataRaaEta60_92);
			book(hEta["PPcross60_92"],"_" + refnameRaaEta60_92 + "_60_92Pcross", refdataRaaEta60_92);
			...
			const Estimate1D& refdataRaaEta0_92 = refData(refnameRaaEta0_92);
			book(hEta["AUAUyield0_92"],"_" + refnameRaaEta0_92 + "_0_92Eta", refdataRaaEta0_92);
			book(hEta["PPcross0_92"],"_" + refnameRaaEta0_92 + "_0_92Pcross", refdataRaaEta0_92);
			book(sRaa["RaaEta0_92"], refnameRaaEta0_92);

			string refnameRaaPi0_92 = mkAxisCode(20,1,1);
			const Estimate1D& refdataRaaPi0_92 = refData(refnameRaaPi0_92);
			book(hPi["AUAUyield0_92Pi"],"_" + refnameRaaPi0_92 + "_0_92Pi", refdataRaaPi0_92);
			book(hPi["PPcross0_92Pi"],"_" + refnameRaaPi0_92 + "_0_92PiPcross", refdataRaaPi0_92);
			book(sRaa["RaaPi0_92"], refnameRaaPi0_92);

			//string refnameRaaEtapT20 = mkAxisCode(22,1,1);
			//const Estimate1D& refdataRaaEtapT20 = refData(refnameRaaEtapT20);
			...
			//const Estimate1D& refdataRaaEtapT5 = refData(refnameRaaEtapT5);
		...
		void finalize() {
			...
			if (pcross["cross_section"]->bin(0).numEntries() > 0) {
				...
				xsec = pcross["cross_section"]->bin(0).xMean()/millibarn;
			}
